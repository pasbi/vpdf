...
cmake_version=$(grep "^project(vpdf VERSION [0-9]\+\.[0-9]\+\.[0-9]\+" CMakeLists.txt | grep -o "[0-9]\+\.[0-9]\+\.[0-9]\+")
...
sed -i -E "s/^(project\(vpdf VERSION )[0-9]+\.[0-9]+\.[0-9]+/\1${version}/" CMakeLists.txt
